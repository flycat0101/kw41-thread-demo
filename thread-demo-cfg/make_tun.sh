...
/root/ip -6 tuntap add mode tun fslthr0
# Assign it a global IPv6 address.
/root/ip -6 addr add FD01::2 dev fslthr0
# Add route to default address of Serial TUN embedded interface.
/root/ip -6 route add FD01::1 dev fslthr0
# Add route to Unique Local /64 Prefix via fslthr0.
/root/ip -6 route add FD01:0000:0000:3EAD::/64 dev fslthr0
# The interface is ready.
/root/ip link set fslthr0 up
